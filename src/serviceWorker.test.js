...
describe("checkValidServiceWorker", () => {
    test("0", () => {
        let callFunction = () => {
            checkValidServiceWorker("Www.GooGle.com", "https://twitter.com/path?abc")
        }
    ...
    test("1", () => {
        let callFunction = () => {
            checkValidServiceWorker("https://twitter.com/path?abc", "https://twitter.com/path?abc")
        }
    ...
    test("2", () => {
        let callFunction = () => {
            checkValidServiceWorker("https://twitter.com/path?abc", "www.google.com")
        }
    ...
    test("3", () => {
        let callFunction = () => {
            checkValidServiceWorker("http://base.com", "http://base.com")
        }
